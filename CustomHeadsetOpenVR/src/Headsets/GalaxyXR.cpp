...
void GalaxyXRShim::TryApplyIdentity(){
	...
	// Match DeviceIdentityPatch exactly. The source serial remains admission/restore data only;
	// publishing it would give SteamVR a different cached device identity on legacy transports.
	const std::string stableSerial = "VRLINKHMDGALAXYXR";
